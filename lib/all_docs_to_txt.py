"""
Скрипт для конвертации всех DOCX файлов в TXT.
Использует функцию convert_docs_to_txt из docx_to_txt.py.
"""
...
def main():
    """Конвертирует все DOCX файлы из data/specifications/docs в data/specifications/texts."""
